...
function setup()
{
    ...
    register_nav_menus([
        ...
        'pictures_navigation'   => __('Pictures Navigation', 'sage'),
    ]);
...
{
    if (is_front_page() || is_page_template('template-elementor.php')) {
...
function assets()
{
    ...
    wp_enqueue_style('sage/fonts', 'https://fonts.googleapis.com/css?family=Lato:400,700|Raleway:300', false, null);
}
